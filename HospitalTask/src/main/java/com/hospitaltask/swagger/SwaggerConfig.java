/*
 * package com.hospitaltask.swagger;
 * 
 ...
 * springfox.documentation.builders.PathSelectors.regex; import static
 ...
 * 
 * private Predicate<String> postPaths() { return or(regex("/deoctor/**"),
 * regex("/patient/**")); }
 * 
 * private ApiInfo apiInfo() { return new ApiInfoBuilder().title("hospital")
 * .description("JavaInUse API reference for developers")
 * .termsOfServiceUrl("http://javainuse.com")
 * .contact("Hospital@gmail.com").license("durgesh")
 * .licenseUrl("Hospital@gmail.com").version("1.0").build(); } }
 */